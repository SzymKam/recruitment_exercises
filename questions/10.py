"""
Połączenie TCP ma cztery parametry dzieki którym można je jednoznacznie zidentyfikować, co to za parametry?

Parametry te są znane jako "czwórka krotek" - four touple

1. Adres IP zródła: adres IP hosta który inicjuje połączenie
